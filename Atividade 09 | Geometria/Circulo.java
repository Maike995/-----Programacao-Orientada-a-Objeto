...
import java.lang.Math;
    ...
    public class Circulo extends Quadrilatero{
        ...
        public float calcularArea() {
            return area = (float)Math.PI * raio * raio;
        }

        public float calcularPerimetro() {
            return perimetro = 2*(float)Math.PI*raio;
        }

        public void dados(){
            System.out.println("Dados do Quadrilatero| Raio: "+raio+" | Area: "+area+" | Perimetro: "+perimetro);
        }
    }